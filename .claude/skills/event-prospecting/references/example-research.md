...
`{OUTPUT_DIR}` is the per-run `gtm-reports/` directory set up by the main agent in Step 0 (e.g., `<project>/gtm-reports/{event_slug}_prospects_2026-04-25-2030/`).
...
```bash
cat << 'PERSON_MD' > <project>/gtm-reports/stripesessions_prospects_2026-04-25-2030/people/greg-brockman.md
---
name: Greg Brockman
slug: greg-brockman
...
