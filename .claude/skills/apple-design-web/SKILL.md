...
This skill is self-contained — the tokens, components and animation values above are the
whole system. For deeper source material, use the sibling skills installed alongside it:
- `apple-design` — Apple's motion/materials craft translated for the web (springs, gestures, depth)
- `apple-design-hig` — the Human Interface Guidelines corpus in `references/hig/` (color, typography,
  layout, materials, liquid-glass, dark-mode, accessibility, motion)
...
### Sibling Skills
- `apple-design` — springs, gestures, interruptible motion, translucent materials
- `apple-design-hig` — full Apple HIG reference set for audits and platform conventions
- `ui-typography` — typographic correctness enforcement (quotes, dashes, spacing)
---
