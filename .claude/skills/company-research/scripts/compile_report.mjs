...
// Example: node compile_report.mjs <project>/gtm-reports/acme_research_2026-04-09
...
Examples:
  node compile_report.mjs <project>/gtm-reports/acme_research_2026-04-09
  node compile_report.mjs <project>/gtm-reports/research --open`);
