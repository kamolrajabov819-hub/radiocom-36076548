...
Where `{OUTPUT_DIR}` is the per-run directory under the project's gitignored `gtm-reports/` (e.g., `<project>/gtm-reports/acme_research_2026-04-23/`). The main agent sets this up in Step 0 and passes the full literal path to every subagent.
