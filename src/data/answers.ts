 ...
 * models, 600 000–2 800 000 сум, 300 м–3 км in town against 3–10 км in the
...
export const publishedAnswers: Answer[] = [
  {
    ...
    answer: {
      ru: "Выбор рации сводится к трём вопросам: на каком расстоянии работают люди, что стоит между ними и сколько часов длится смена. Ответьте на эти три — и подойдёт одна из 21 модели, которая есть в наличии в Ташкенте.",
  ...
  },
  {
    ...
    answer: {
      ru: "В наличии 21 модель по цене от 600 000 до 2 800 000 сум. Разброс объясняется тремя вещами: дальностью, защитой от пыли и воды и тем, аналоговая рация или цифровая.",
      en: "There are 21 models in stock, from 600 000 to 2 800 000 UZS. The spread comes down to three things: range, protection against dust and water, and whether the radio is analogue or digital.",
      uz: "Mavjud 21 model narxi 600 000 dan 2 800 000 so'mgacha. Farq uchta narsaga bog'liq: masofa, chang va suvdan himoya va ratsiya analog yoki raqamli ekani.",
    },
    metaTitle: {
    ...
    metaDesc: {
      ru: "Сколько стоит рация в Ташкенте: 21 модель от 600 000 до 2 800 000 сум. От чего зависит цена, что входит в комплект и почему дешёвая выходит дороже.",
      en: "What a two-way radio costs in Tashkent: 21 models from 600 000 to 2 800 000 UZS. What sets the price, what is in the box, and why cheap ends up dearer.",
      uz: "Toshkentda ratsiya qancha turadi: 600 000 dan 2 800 000 so'mgacha 21 model. Narx nimaga bog'liq, komplektda nima bor va nega arzoni qimmatga tushadi.",
    },
