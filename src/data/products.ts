...
export const products: Product[] = [
  ...
  { id: "rc-50", name: "Radiocom RC-50", brand: RC, category: "professional", image: rc50.url, tags: ["Long range"], price: 1_500_000, rangeCity: "до 2,5 км", rangeOpen: "до 5 км", industries: ["construction","security","transport"], blurb: "Универсальная модель для среднего радиуса действия." },
  { id: "rc-20", name: "Radiocom RC-20", brand: RC, category: "amateur", image: rc20.url, tags: ["Compact", "License-free"], price: 1_400_000, rangeCity: "до 1,5 км", rangeOpen: "до 4 км", industries: ["horeca","security"], blurb: "Лёгкая рация для персонала — комплект с зарядкой и гарнитурой." },
